class Article:
    ...
    def title(self, new_title):
        if(isinstance(new_title, str) and 5 <= len(new_title) <= 50 and not hasattr(self, 'title')):
            ...
            raise Exception('article title went wrong')
    ...
    def author(self, new_author):
        if(isinstance(new_author, Author)):
            ...
            print('article author must be type Author')
    ...
    def magazine(self, new_magazine):
        if(isinstance(new_magazine, Magazine)):
            ...
            print('article magazine must be type Magazine')
...
class Author:
    ...
    def name(self, new_name):
        if(isinstance(new_name, str) and len(new_name) > 0 and not hasattr(self, 'name')):
            ...
            print('something went wrong creating article name')
...
class Magazine:
    ...
    def name(self, new_name):
        if(isinstance(new_name, str) and 2 <= len(new_name) <= 16):
            ...
            print('something went wrong creating magazine name')
    ...
    def category(self, new_category):
        if(isinstance(new_category, str) and 0 < len(new_category)):
            ...
            print('something went wrong creating magazine category')
